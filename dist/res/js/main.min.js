...
Mavo.Actions.running = Mavo.Actions._running;`),new Function("data",e)):()=>""},parse:self.jsep,serializeScopeCall:e=>{var t=`with (Mavo.Script.subScope(scope, $this) || {}) { return (${u.serialize(e[1])}); }`;return`(function() {
	...
	${t}
			...
			</form>`,{classes:"mv-inline",dismiss:["button","submit"]}),this.notice.closed.then(e=>{e&&(history.pushState({},"",location.pathname+"?"+t),location.replace(location.pathname+"?"+t))})}static apiDomain="https://api.github.com/";static oAuth="https://github.com/login/oauth/authorize";static key="7e08e016048000bc594e";static test(e){return e=new URL(e,Mavo.base),/^((api\.)?github\.com|raw\.githubusercontent\.com)/.test(e.host)}static parseURL(e,t={}){var i={},r=(Object.defineProperties(i,{apiCall:{get(){let e=`repos/${this.username}/${this.repo}/`+(this.resources??"contents");var t=this.path;return t&&(e+="/"+t),e+(this.apiParams??"")},set(e){delete this.apiCall,this.apiCall=e},configurable:!0,enumerable:!0},path:{get(){return this.filename?(this.filepath?this.filepath+"/":"")+this.filename:this.filepath},set(e){delete this.path,this.path=e},configurable:!0,enumerable:!0}}),new URL(e,Mavo.base));let s=r.pathname.slice(1).split("/");if(i.username=s.shift(),i.repo=s.shift()||t.repo,/raw.githubusercontent.com$/.test(r.host))i.branch=s.shift();else if(/api.github.com$/.test(r.host)){delete i.username,delete i.repo,i.apiParams=r.search,i.apiData=Mavo.Functions.from(e,"#");e=r.pathname.slice(1)+i.apiParams;if("graphql"==e)return i.apiCall=e,i.apiData={query:i.apiData},i;if("repos"!=(s=r.pathname.slice(1).split("/")).shift())return i.apiCall=e,i;i.username=s.shift(),i.repo=s.shift(),i.resources=s.shift()}else"blob"==s[0]&&(s.shift(),i.branch=s.shift());r=s[s.length-1];return/\.\w+$/.test(r)?(i.filename=r,s.splice(s.length-1,1)):i.filename=i.hasOwnProperty("apiParams")?"":t.filename,i.filepath=s.join("/")||t.filepath||"",i}static btoa=e=>btoa(unescape(encodeURIComponent(e)));static atob=e=>decodeURIComponent(escape(window.atob(e)))})}(Bliss,Bliss.$),!function(e){let r={newdocument:"core",bold:"core",italic:"core",underline:"core",strikethrough:"core",alignleft:"core",aligncenter:"core",alignright:"core",alignjustify:"core",alignnone:"core",styleselect:"core",formatselect:"core",fontselect:"core",fontsizeselect:"core",cut:"core",copy:"core",paste:"core",outdent:"core",indent:"core",blockquote:"core",undo:"core",redo:"core",removeformat:"core",subscript:"core",superscript:"core",visualaid:"core",insert:"core",hr:"hr",bullist:"lists",numlist:"lists",link:"link",unlink:"link",openlink:"link",image:"image",charmap:"charmap",pastetext:"paste",print:"print",preview:"preview",anchor:"anchor",pagebreak:"pagebreak",spellchecker:"spellchecker",searchreplace:"searchreplace",visualblocks:"visualblocks",visualchars:"visualchars",code:"code",help:"help",fullscreen:"fullscreen",insertdatetime:"insertdatetime",media:"media",nonbreaking:"nonbreaking",save:"save",cancel:"save",table:"table",tabledelete:"table",tablecellprops:"table",tablemergecells:"table",tablesplitcells:"table",tableinsertrowbefore:"table",tableinsertrowafter:"table",tabledeleterow:"table",tablerowprops:"table",tablecutrow:"table",tablecopyrow:"table",tablepasterowbefore:"table",tablepasterowafter:"table",tableinsertcolbefore:"table",tableinsertcolafter:"table",tabledeletecol:"table",rotateleft:"imagetools",rotateright:"imagetools",flipv:"imagetools",fliph:"imagetools",editimage:"imagetools",imageoptions:"imagetools",fullpage:"fullpage",ltr:"directionality",rtl:"directionality",emoticons:"emoticons",template:"template",forecolor:"textcolor",backcolor:"textcolor",toc:"toc"},i,s;Mavo.Plugins.register("tinymce",{ready:e.include(self.tinymce,"/res/js/lib/tinymce-4.9.11.min.js").then(()=>{i=new tinymce.html.DomParser,s=new tinymce.html.Serializer})}),Mavo.Elements.register(".tinymce",{hasChildren:!0,default:!0,edit:function(){(this.preEdit||Promise.resolve()).then(e=>{if("abort"!==e)if(this.element.tinymce)tinymce.EditorManager.execCommand("mceAddEditor",!0,this.element.tinymce.id);else{var e=this.element.getAttribute("mv-tinymce-toolbar")?.trim()||"styleselect | bold italic | image link | table | bullist numlist",t=e.split("|").filter(e=>e.length).join(" ").split(/\s+/);let i=new Set;i.add("tabfocus"),t.forEach(e=>{var t=r[e];t?i.add(t):Mavo.warn(`Button with the name "${e}" can't be added to the toolbar since it is not supported by the TinyMCE plugin.`)}),i.delete("core"),tinymce.init({target:this.element,inline:!0,menubar:!1,toolbar:e,plugins:Array.from(i).join(" ")}).then(e=>{this.element.tinymce=e[0],this.element.tinymce.on("change keyup paste cut",e=>{this.value=this.getValue()})})}})},done:function(){this.element.tinymce&&tinymce.EditorManager.execCommand("mceRemoveEditor",!0,this.element.tinymce.id)},getValue:e=>e.tinymce?e.tinymce.getContent():e.innerHTML,setValue:(e,t)=>{t=s.serialize(i.parse(t));e.tinymce?e.tinymce.isHidden()&&e.tinymce.setContent(t):e.innerHTML=t}})}(Bliss),Mavo.Locale.register("fr",{second:"seconde",seconds:"secondes",minute:"minute",minutes:"minutes",hour:"heure",hours:"heures",day:"jour",days:"jours",week:"semaine",weeks:"semaines",month:"mois",months:"mois",year:"année",years:"années",edit:"Modifier",editing:"Modification",save:"Enregistrer",import:"Import",export:"Export",clear:"Vider",logout:"Déconnexion",login:"Connexion",loading:"Chargement",uploading:"Téléchargement",saving:"Enregistrement",dismiss:"Abandonner","logged-in-as":"Connecté à {id} en tant que ","login-to":"Se connecter à {id}","error-uploading":"Erreur lors de l’envoi du fichier","cannot-load-uploaded-file":"Erreur lors du chargement du fichier envoyé",filename:"Nom du fichier ?","problem-saving":"Erreur lors de l’enregistrement des données","problem-loading":"Erreur lors du chargement des données","cannot-parse":"Ce fichier ne peut pas être lu correctement","http-error":"Erreur HTTP {status} : {statusText}","cant-connect":"Connexion à Internet impossible","add-item":"Ajouter {name}","add-item-before":"Ajouter un nouvel élément {name} avant","add-item-after":"Ajouter un nouvel élément {name} après","drag-to-reorder":"Faire glisser pour réordonner les {name}","delete-item":"Supprimer ce {name}","item-deleted":"{name} supprimé","n-items":"{n} éléments {name}",undo:"Défaire","delete-confirmation":"Toutes vos données vont être supprimées. Êtes-vous sûr ?","gh-updated-file":"{name} mis à jour","gh-edit-suggestion-saved-in-profile":'Vos modifications vont être enregistrées sur <a href="{previewURL}" target="_blank">votre profil</a>, car vous n’avez pas le droit de modifier cette page.',"gh-edit-suggestion-instructions":"Écrivez une description courte de vos modifications ci-dessous pour les suggérer aux administrateurs","gh-edit-suggestion-notreviewed":"Vous aviez choisi de suggérer les modifications aux administrateurs. Celles-ci n'ont pas encore été vérifiées.","gh-edit-suggestion-send":"Envoyer une suggestion de modification","gh-edit-suggestion-revoke":"Annuler votre suggestion de modification","gh-edit-suggestion-reason-placeholder":"J’ai ajouté / corrigé / supprimé ...","gh-edit-suggestion-cancelled":"Suggestion de modification correctement annulée !","gh-edit-suggestion-title":"Suggérer des modifications aux données","gh-edit-suggestion-body":`Bonjour ! J'ai utilisé Mavo pour vous suggérer les modifications suivantes :
{description}
Prévisualisez mes changements ici : {previewURL}`,"gh-edit-suggestion-sent":"Suggestion de modification correctement envoyée !","gh-login-fork-options":"Vous avez une version de cette page, voulez-vous l’utiliser ?","gh-use-my-fork":"Oui, utilise mes données."}),!function(r){Mavo.Plugins.register("cropper",{dependencies:["https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.12/cropper.min.js","https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.12/cropper.min.css","https://cdn.jsdelivr.net/gh/DmitrySharabin/mavo-cropper/mavo-cropper.css"],hooks:{"primitive-createuploadpopup-beforereturn":function(i){if("image"===i.kind){let e={viewMode:2,autoCrop:!1},t=this;this.options=this.element.getAttribute("mv-cropper-options"),this.options?this.options=r.extend(e,Mavo.options(this.options)):this.options=e,void 0===this.data&&i.popup.classList.add("cropper-no-image"),r.create("div",{className:"cropper-wrapper",contents:[{tag:"img",src:this.data||"",alt:this.mavo._("cropper-image-preview"),className:"cropper-preview",style:{maxWidth:this.element.offsetWidth+"px",maxHeight:this.element.offsetHeight+"px"}}],inside:i.popup}),this.cropper=new Cropper(r(".cropper-preview",i.popup),this.options),r.create("div",{className:"cropper-bar",inside:i.popup}),this.cropper.options.rotatable&&(r.create("button",{type:"button",className:"cropper-rotate-left",title:this.mavo._("cropper-rotate-left"),events:{click:()=>{this.cropper.rotate(-90)}},inside:r(".cropper-bar",i.popup)}),r.create("button",{type:"button",className:"cropper-rotate-right",title:this.mavo._("cropper-rotate-right"),events:{click:()=>{this.cropper.rotate(90)}},inside:r(".cropper-bar",i.popup)})),this.cropper.options.scalable&&(r.create("button",{type:"button",className:"cropper-flip-horizontal",title:this.mavo._("cropper-flip-horizontal"),events:{click:()=>{this.cropper.scaleX(-this.cropper.getData().scaleX||-1)}},inside:r(".cropper-bar",i.popup)}),r.create("button",{type:"button",className:"cropper-flip-vertical",title:this.mavo._("cropper-flip-vertical"),events:{click:()=>{this.cropper.scaleY(-this.cropper.getData().scaleY||-1)}},inside:r(".cropper-bar",i.popup)})),r.create("button",{type:"button",className:"cropper-crop",events:{click:function(){this.classList.toggle("cropper-crop-hidden"),this.classList.contains("cropper-crop-hidden")?(this.setAttribute("title",t.mavo._("cropper-show")),r(".cropper-aspect-ratio",i.popup).disabled=!0,t.cropper.setDragMode(),t.cropper.clear()):(this.setAttribute("title",t.mavo._("cropper-hide")),r(".cropper-aspect-ratio",i.popup).disabled=!1,t.cropper.setDragMode("crop"),t.cropper.crop())}},inside:r(".cropper-bar",i.popup)}),r.create("select",{className:"cropper-aspect-ratio",title:this.mavo._("cropper-aspect-ratio"),contents:[{tag:"option",value:NaN,textContent:this.mavo._("cropper-aspect-ratio-free")},{tag:"option",value:1,textContent:"1:1"},{tag:"option",value:4/3,textContent:"4:3"},{tag:"option",value:16/9,textContent:"16:9"},{tag:"option",value:2/3,textContent:"2:3"}],events:{change:e=>{"custom"===e.target.value?this.cropper.setAspectRatio(this.options.aspectRatio):this.cropper.setAspectRatio(e.target.value)}},inside:r(".cropper-bar",i.popup)}),r.create("button",{type:"button",className:"cropper-upload",title:this.mavo._("cropper-upload"),events:{click:()=>{this.fileName=this.element.src.split("/").pop(),this.fileType="image/"+("png"===this.fileName.split(".")[1]?"png":"jpeg"),this.cropper.getCroppedCanvas("image/png"===this.fileType?{}:{fillColor:"#fff"}).toBlob(e=>{this.upload(e,this.fileName),this.updatePreview()},this.fileType)}},inside:r(".cropper-bar",i.popup)}),r.create("button",{type:"button",className:"cropper-update",title:this.mavo._("cropper-update"),events:{click:()=>{this.updatePreview()}},inside:r(".cropper-bar",i.popup)}),this.cropper.options.autoCrop?(r.set(r(".cropper-crop",i.popup),{className:"cropper-crop",title:this.mavo._("cropper-hide")}),r.set(r(".cropper-aspect-ratio",i.popup),{disabled:!1}),this.cropper.options.aspectRatio&&r.set(document.createElement("option"),{value:"custom",textContent:this.mavo._("cropper-aspect-ratio-custom"),selected:!0,start:r(".cropper-aspect-ratio",i.popup)}),this.cropper.setDragMode(this.cropper.options.dragMode)):(r.set(r(".cropper-crop",i.popup),{className:"cropper-crop cropper-crop-hidden",title:this.mavo._("cropper-show")}),r(".cropper-aspect-ratio",i.popup).disabled=!0,this.cropper.options.dragMode="none"),r.bind(i.popup,"paste drop",()=>{this.updatePreview()}),r.bind(this.element,"paste drop",()=>{this.updatePreview()}),r.bind(r("input[type=url]",i.popup),"input",()=>{this.updatePreview()}),r.bind(r("input[type=file]",i.popup),"change",()=>{this.updatePreview()}),this.updatePreview=()=>{this.element.src?(r(".cropper-preview",i.popup).style.maxWidth=this.element.offsetWidth+"px",r(".cropper-preview",i.popup).style.maxHeight=this.element.offsetHeight+"px",this.cropper.replace(this.element.src),this.cropper.options.autoCrop?r("button.cropper-crop",r(".cropper-bar",i.popup)).classList.contains("cropper-crop-hidden")&&(this.cropper.options.dragMode="crop",r.fire(r("button.cropper-crop",r(".cropper-bar",i.popup)),"click")):r("button.cropper-crop",r(".cropper-bar",i.popup)).classList.contains("cropper-crop-hidden")||(this.cropper.options.dragMode="none",r.fire(r("button.cropper-crop",r(".cropper-bar",i.popup)),"click")),i.popup.classList.remove("cropper-no-image")):i.popup.classList.add("cropper-no-image")}}}}}),Mavo.Locale.register("en",{"cropper-image-preview":"Image preview","cropper-upload":"Upload Image","cropper-show":"Show Crop Box","cropper-hide":"Hide Crop Box","cropper-rotate-left":"Rotate Left","cropper-rotate-right":"Rotate Right","cropper-flip-horizontal":"Flip Horizontal","cropper-flip-vertical":"Flip Vertical","cropper-aspect-ratio":"Crop Box Aspect Ratio","cropper-aspect-ratio-free":"Free","cropper-aspect-ratio-custom":"Custom","cropper-update":"Update Preview"})}(Bliss),!function(){function R(e){var t=new R.Builder;return t.pipeline.add(R.trimmer,R.stopWordFilter,R.stemmer),t.searchPipeline.add(R.stemmer),e.call(t,t),t.build()}var t,u,h,c,d,p,m,v,f,g,y,b,x,M,w,E,A,k,C,L,O,S,P,e,i;function r(e){var t,i,r,s,n,a,o,l;return e.length<3||("y"==(l=e.substr(0,1))&&(e=l.toUpperCase()+e.substr(1)),a=f,(s=v).test(e)?e=e.replace(s,"$1$2"):a.test(e)&&(e=e.replace(a,"$1$2")),a=y,(s=g).test(e)?(o=s.exec(e),(s=c).test(o[1])&&(e=e.replace(s=b,""))):a.test(e)&&(n=(o=a.exec(e))[1],(a=m).test(n))&&(e=n,i=M,r=w,(a=x).test(e)?e+="e":i.test(e)?e=e.replace(s=b,""):r.test(e)&&(e+="e")),(s=E).test(e)&&(e=(n=(o=s.exec(e))[1])+"i"),(s=A).test(e)&&(n=(o=s.exec(e))[1],t=o[2],(s=c).test(n))&&(e=n+u[t]),(s=k).test(e)&&(n=(o=s.exec(e))[1],t=o[2],(s=c).test(n))&&(e=n+h[t]),a=L,(s=C).test(e)?(n=(o=s.exec(e))[1],(s=d).test(n)&&(e=n)):a.test(e)&&(n=(o=a.exec(e))[1]+o[2],(a=d).test(n))&&(e=n),(s=O).test(e)&&(n=(o=s.exec(e))[1],a=p,i=P,(s=d).test(n)||a.test(n)&&!i.test(n))&&(e=n),a=d,(s=S).test(e)&&a.test(e)&&(e=e.replace(s=b,"")),"y"==l&&(e=l.toLowerCase()+e.substr(1))),e}R.version="2.3.9",(R.utils={}).warn=(t=this,function(e){t.console&&console.warn&&console.warn(e)}),R.utils.asString=function(e){return null==e?"":e.toString()},R.utils.clone=function(e){if(null==e)return e;for(var t=Object.create(null),i=Object.keys(e),r=0;r<i.length;r++){var s=i[r],n=e[s];if(Array.isArray(n))t[s]=n.slice();else{if("string"!=typeof n&&"number"!=typeof n&&"boolean"!=typeof n)throw new TypeError("clone is not deep and does not support nested objects");t[s]=n}}return t},(R.FieldRef=function(e,t,i){this.docRef=e,this.fieldName=t,this._stringValue=i}).joiner="/",R.FieldRef.fromString=function(e){var t=e.indexOf(R.FieldRef.joiner);if(-1===t)throw"malformed field ref string";var i=e.slice(0,t),t=e.slice(t+1);return new R.FieldRef(t,i,e)},R.FieldRef.prototype.toString=function(){return null==this._stringValue&&(this._stringValue=this.fieldName+R.FieldRef.joiner+this.docRef),this._stringValue},(R.Set=function(e){if(this.elements=Object.create(null),e){this.length=e.length;for(var t=0;t<this.length;t++)this.elements[e[t]]=!0}else this.length=0}).complete={intersect:function(e){return e},union:function(){return this},contains:function(){return!0}},R.Set.empty={intersect:function(){return this},union:function(e){return e},contains:function(){return!1}},R.Set.prototype.contains=function(e){return!!this.elements[e]},R.Set.prototype.intersect=function(e){var t,i=[];if(e===R.Set.complete)return this;if(e===R.Set.empty)return e;for(var r=this.length<e.length?(t=this,e):(t=e,this),s=Object.keys(t.elements),n=0;n<s.length;n++){var a=s[n];a in r.elements&&i.push(a)}return new R.Set(i)},R.Set.prototype.union=function(e){return e===R.Set.complete?R.Set.complete:e===R.Set.empty?this:new R.Set(Object.keys(this.elements).concat(Object.keys(e.elements)))},R.idf=function(e,t){var i,r=0;for(i in e)"_index"!=i&&(r+=Object.keys(e[i]).length);return Math.log(1+Math.abs((t-r+.5)/(r+.5)))},(R.Token=function(e,t){this.str=e||"",this.metadata=t||{}}).prototype.toString=function(){return this.str},R.Token.prototype.update=function(e){return this.str=e(this.str,this.metadata),this},R.Token.prototype.clone=function(e){return new R.Token((e=e||function(e){return e})(this.str,this.metadata),this.metadata)},(R.tokenizer=function(e,t){if(null==e)return[];if(Array.isArray(e))return e.map(function(e){return new R.Token(R.utils.asString(e).toLowerCase(),R.utils.clone(t))});for(var i=e.toString().toLowerCase(),r=i.length,s=[],n=0,a=0;n<=r;n++){var o,l=n-a;!i.charAt(n).match(R.tokenizer.separator)&&n!=r||(0<l&&((o=R.utils.clone(t)||{}).position=[a,l],o.index=s.length,s.push(new R.Token(i.slice(a,n),o))),a=n+1)}return s}).separator=/[\s\-]+/,(R.Pipeline=function(){this._stack=[]}).registeredFunctions=Object.create(null),R.Pipeline.registerFunction=function(e,t){t in this.registeredFunctions&&R.utils.warn("Overwriting existing registered function: "+t),e.label=t,R.Pipeline.registeredFunctions[e.label]=e},R.Pipeline.warnIfFunctionNotRegistered=function(e){e.label&&e.label in this.registeredFunctions||R.utils.warn("Function is not registered with pipeline. This may cause problems when serialising the index.\n",e)},R.Pipeline.load=function(e){var i=new R.Pipeline;return e.forEach(function(e){var t=R.Pipeline.registeredFunctions[e];if(!t)throw new Error("Cannot load unregistered function: "+e);i.add(t)}),i},R.Pipeline.prototype.add=function(){Array.prototype.slice.call(arguments).forEach(function(e){R.Pipeline.warnIfFunctionNotRegistered(e),this._stack.push(e)},this)},R.Pipeline.prototype.after=function(e,t){R.Pipeline.warnIfFunctionNotRegistered(t);e=this._stack.indexOf(e);if(-1==e)throw new Error("Cannot find existingFn");this._stack.splice(e+=1,0,t)},R.Pipeline.prototype.before=function(e,t){R.Pipeline.warnIfFunctionNotRegistered(t);e=this._stack.indexOf(e);if(-1==e)throw new Error("Cannot find existingFn");this._stack.splice(e,0,t)},R.Pipeline.prototype.remove=function(e){e=this._stack.indexOf(e);-1!=e&&this._stack.splice(e,1)},R.Pipeline.prototype.run=function(e){for(var t=this._stack.length,i=0;i<t;i++){for(var r=this._stack[i],s=[],n=0;n<e.length;n++){var a=r(e[n],n,e);if(null!=a&&""!==a)if(Array.isArray(a))for(var o=0;o<a.length;o++)s.push(a[o]);else s.push(a)}e=s}return e},R.Pipeline.prototype.runString=function(e,t){e=new R.Token(e,t);return this.run([e]).map(function(e){return e.toString()})},R.Pipeline.prototype.reset=function(){this._stack=[]},R.Pipeline.prototype.toJSON=function(){return this._stack.map(function(e){return R.Pipeline.warnIfFunctionNotRegistered(e),e.label})},(R.Vector=function(e){this._magnitude=0,this.elements=e||[]}).prototype.positionForIndex=function(e){if(0==this.elements.length)return 0;for(var t=0,i=this.elements.length/2,r=i-t,s=Math.floor(r/2),n=this.elements[2*s];1<r&&(n<e&&(t=s),e<n&&(i=s),n!=e);)r=i-t,s=t+Math.floor(r/2),n=this.elements[2*s];return n==e||e<n?2*s:n<e?2*(s+1):void 0},R.Vector.prototype.insert=function(e,t){this.upsert(e,t,function(){throw"duplicate index"})},R.Vector.prototype.upsert=function(e,t,i){this._magnitude=0;var r=this.positionForIndex(e);this.elements[r]==e?this.elements[r+1]=i(this.elements[r+1],t):this.elements.splice(r,0,e,t)},R.Vector.prototype.magnitude=function(){if(this._magnitude)return this._magnitude;for(var e=0,t=this.elements.length,i=1;i<t;i+=2){var r=this.elements[i];e+=r*r}return this._magnitude=Math.sqrt(e)},R.Vector.prototype.dot=function(e){for(var t,i,r=0,s=this.elements,n=e.elements,a=s.length,o=n.length,l=0,u=0;l<a&&u<o;)(t=s[l])<(i=n[u])?l+=2:i<t?u+=2:t==i&&(r+=s[l+1]*n[u+1],l+=2,u+=2);return r},R.Vector.prototype.similarity=function(e){return this.dot(e)/this.magnitude()||0},R.Vector.prototype.toArray=function(){for(var e=new Array(this.elements.length/2),t=1,i=0;t<this.elements.length;t+=2,i++)e[i]=this.elements[t];return e},R.Vector.prototype.toJSON=function(){return this.elements},u={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},h={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},i="[aeiouy]",e="[^aeiou][^aeiouy]*",c=new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*"),d=new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*[aeiouy][aeiou]*[^aeiou][^aeiouy]*"),p=new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*([aeiouy][aeiou]*)?$"),m=new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy]"),v=/^(.+?)(ss|i)es$/,f=/^(.+?)([^s])s$/,g=/^(.+?)eed$/,y=/^(.+?)(ed|ing)$/,b=/.$/,x=/(at|bl|iz)$/,M=new RegExp("([^aeiouylsz])\\1$"),w=new RegExp("^"+e+i+"[^aeiouwxy]$"),E=/^(.+?[^aeiou])y$/,A=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,k=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,C=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,L=/^(.+?)(s|t)(ion)$/,O=/^(.+?)e$/,S=/ll$/,P=new RegExp("^"+e+i+"[^aeiouwxy]$"),R.Pipeline.registerFunction(R.stemmer=function(e){return e.update(r)},"stemmer"),R.stopWordFilter=(R.generateStopWordFilter=function(e){var t=e.reduce(function(e,t){return e[t]=t,e},{});return function(e){if(e&&t[e.toString()]!==e.toString())return e}})(["a","able","about","across","after","all","almost","also","am","among","an","and","any","are","as","at","be","because","been","but","by","can","cannot","could","dear","did","do","does","either","else","ever","every","for","from","get","got","had","has","have","he","her","hers","him","his","how","however","i","if","in","into","is","it","its","just","least","let","like","likely","may","me","might","most","must","my","neither","no","nor","not","of","off","often","on","only","or","other","our","own","rather","said","say","says","she","should","since","so","some","than","that","the","their","them","then","there","these","they","this","tis","to","too","twas","us","wants","was","we","were","what","when","where","which","while","who","whom","why","will","with","would","yet","you","your"]),R.Pipeline.registerFunction(R.stopWordFilter,"stopWordFilter"),R.Pipeline.registerFunction(R.trimmer=function(e){return e.update(function(e){return e.replace(/^\W+/,"").replace(/\W+$/,"")})},"trimmer"),(R.TokenSet=function(){this.final=!1,this.edges={},this.id=R.TokenSet._nextId,R.TokenSet._nextId+=1})._nextId=1,R.TokenSet.fromArray=function(e){for(var t=new R.TokenSet.Builder,i=0,r=e.length;i<r;i++)t.insert(e[i]);return t.finish(),t.root},R.TokenSet.fromClause=function(e){return"editDistance"in e?R.TokenSet.fromFuzzyString(e.term,e.editDistance):R.TokenSet.fromString(e.term)},R.TokenSet.fromFuzzyString=function(e,t){for(var i=new R.TokenSet,r=[{node:i,editsRemaining:t,str:e}];r.length;){var s,n,a,o,l,u,h=r.pop();0<h.str.length&&((o=h.str.charAt(0))in h.node.edges?s=h.node.edges[o]:(s=new R.TokenSet,h.node.edges[o]=s),1==h.str.length&&(s.final=!0),r.push({node:s,editsRemaining:h.editsRemaining,str:h.str.slice(1)})),0!=h.editsRemaining&&("*"in h.node.edges?n=h.node.edges["*"]:(n=new R.TokenSet,h.node.edges["*"]=n),0==h.str.length&&(n.final=!0),r.push({node:n,editsRemaining:h.editsRemaining-1,str:h.str}),1<h.str.length&&r.push({node:h.node,editsRemaining:h.editsRemaining-1,str:h.str.slice(1)}),1==h.str.length&&(h.node.final=!0),1<=h.str.length&&("*"in h.node.edges?a=h.node.edges["*"]:(a=new R.TokenSet,h.node.edges["*"]=a),1==h.str.length&&(a.final=!0),r.push({node:a,editsRemaining:h.editsRemaining-1,str:h.str.slice(1)})),1<h.str.length)&&(o=h.str.charAt(0),(l=h.str.charAt(1))in h.node.edges?u=h.node.edges[l]:(u=new R.TokenSet,h.node.edges[l]=u),1==h.str.length&&(u.final=!0),r.push({node:u,editsRemaining:h.editsRemaining-1,str:o+h.str.slice(2)}))}return i},R.TokenSet.fromString=function(e){for(var t=new R.TokenSet,i=t,r=0,s=e.length;r<s;r++){var n,a=e[r],o=r==s-1;"*"==a?(t.edges[a]=t).final=o:((n=new R.TokenSet).final=o,t.edges[a]=n,t=n)}return i},R.TokenSet.prototype.toArray=function(){for(var e=[],t=[{prefix:"",node:this}];t.length;){var i=t.pop(),r=Object.keys(i.node.edges),s=r.length;i.node.final&&(i.prefix.charAt(0),e.push(i.prefix));for(var n=0;n<s;n++){var a=r[n];t.push({prefix:i.prefix.concat(a),node:i.node.edges[a]})}}return e},R.TokenSet.prototype.toString=function(){if(this._str)return this._str;for(var e=this.final?"1":"0",t=Object.keys(this.edges).sort(),i=t.length,r=0;r<i;r++)var s=t[r],e=e+s+this.edges[s].id;return e},R.TokenSet.prototype.intersect=function(e){for(var t=new R.TokenSet,i=void 0,r=[{qNode:e,output:t,node:this}];r.length;)for(var i=r.pop(),s=Object.keys(i.qNode.edges),n=s.length,a=Object.keys(i.node.edges),o=a.length,l=0;l<n;l++)for(var u=s[l],h=0;h<o;h++){var c,d,p,m,v=a[h];v!=u&&"*"!=u||(c=i.node.edges[v],d=i.qNode.edges[u],p=c.final&&d.final,m=void 0,v in i.output.edges?(m=i.output.edges[v]).final=m.final||p:((m=new R.TokenSet).final=p,i.output.edges[v]=m),r.push({qNode:d,output:m,node:c}))}return t},R.TokenSet.Builder=function(){this.previousWord="",this.root=new R.TokenSet,this.uncheckedNodes=[],this.minimizedNodes={}},R.TokenSet.Builder.prototype.insert=function(e){var t=0;if(e<this.previousWord)throw new Error("Out of order word insertion");for(var i=0;i<e.length&&i<this.previousWord.length&&e[i]==this.previousWord[i];i++)t++;this.minimize(t);for(var r=0==this.uncheckedNodes.length?this.root:this.uncheckedNodes[this.uncheckedNodes.length-1].child,i=t;i<e.length;i++){var s=new R.TokenSet,n=e[i];r.edges[n]=s,this.uncheckedNodes.push({parent:r,char:n,child:s}),r=s}r.final=!0,this.previousWord=e},R.TokenSet.Builder.prototype.finish=function(){this.minimize(0)},R.TokenSet.Builder.prototype.minimize=function(e){for(var t=this.uncheckedNodes.length-1;e<=t;t--){var i=this.uncheckedNodes[t],r=i.child.toString();r in this.minimizedNodes?i.parent.edges[i.char]=this.minimizedNodes[r]:(i.child._str=r,this.minimizedNodes[r]=i.child),this.uncheckedNodes.pop()}},(R.Index=function(e){this.invertedIndex=e.invertedIndex,this.fieldVectors=e.fieldVectors,this.tokenSet=e.tokenSet,this.fields=e.fields,this.pipeline=e.pipeline}).prototype.search=function(t){return this.query(function(e){new R.QueryParser(t,e).parse()})},R.Index.prototype.query=function(e){for(var t=new R.Query(this.fields),i=Object.create(null),r=Object.create(null),s=Object.create(null),n=Object.create(null),a=Object.create(null),o=0;o<this.fields.length;o++)r[this.fields[o]]=new R.Vector;e.call(t,t);for(o=0;o<t.clauses.length;o++){for(var l=t.clauses[o],u=null,h=R.Set.empty,u=l.usePipeline?this.pipeline.runString(l.term,{fields:l.fields}):[l.term],c=0;c<u.length;c++){var d=u[c],d=(l.term=d,R.TokenSet.fromClause(l)),p=this.tokenSet.intersect(d).toArray();if(0===p.length&&l.presence===R.Query.presence.REQUIRED){for(var m=0;m<l.fields.length;m++)n[C=l.fields[m]]=R.Set.empty;break}for(var v=0;v<p.length;v++)for(var f=p[v],g=this.invertedIndex[f],D=g._index,m=0;m<l.fields.length;m++){var y=g[C=l.fields[m]],b=Object.keys(y),x=f+"/"+C,M=new R.Set(b);if(l.presence==R.Query.presence.REQUIRED&&(h=h.union(M),void 0===n[C])&&(n[C]=R.Set.complete),l.presence==R.Query.presence.PROHIBITED)void 0===a[C]&&(a[C]=R.Set.empty),a[C]=a[C].union(M);else if(r[C].upsert(D,l.boost,function(e,t){return e+t}),!s[x]){for(var w=0;w<b.length;w++){var E,A=b[w],k=new R.FieldRef(A,C),A=y[A];void 0===(E=i[k])?i[k]=new R.MatchData(f,C,A):E.add(f,C,A)}s[x]=!0}}}if(l.presence===R.Query.presence.REQUIRED)for(m=0;m<l.fields.length;m++)n[C=l.fields[m]]=n[C].intersect(h)}for(var C,L=R.Set.complete,O=R.Set.empty,o=0;o<this.fields.length;o++)n[C=this.fields[o]]&&(L=L.intersect(n[C])),a[C]&&(O=O.union(a[C]));var S=Object.keys(i),P=[],N=Object.create(null);if(t.isNegated())for(S=Object.keys(this.fieldVectors),o=0;o<S.length;o++){var k=S[o],T=R.FieldRef.fromString(k);i[k]=new R.MatchData}for(o=0;o<S.length;o++){var I,$,j=(T=R.FieldRef.fromString(S[o])).docRef;!L.contains(j)||O.contains(j)||(I=this.fieldVectors[T],I=r[T.fieldName].similarity(I),void 0!==($=N[j])?($.score+=I,$.matchData.combine(i[T])):($={ref:j,score:I,matchData:i[T]},N[j]=$,P.push($)))}return P.sort(function(e,t){return t.score-e.score})},R.Index.prototype.toJSON=function(){var e=Object.keys(this.invertedIndex).sort().map(function(e){return[e,this.invertedIndex[e]]},this),t=Object.keys(this.fieldVectors).map(function(e){return[e,this.fieldVectors[e].toJSON()]},this);return{version:R.version,fields:this.fields,fieldVectors:t,invertedIndex:e,pipeline:this.pipeline.toJSON()}},R.Index.load=function(e){var t={},i={},r=e.fieldVectors,s=Object.create(null),n=e.invertedIndex,a=new R.TokenSet.Builder,o=R.Pipeline.load(e.pipeline);e.version!=R.version&&R.utils.warn("Version mismatch when loading serialised index. Current version of lunr '"+R.version+"' does not match serialized index '"+e.version+"'");for(var l=0;l<r.length;l++){var u=(c=r[l])[0],h=c[1];i[u]=new R.Vector(h)}for(l=0;l<n.length;l++){var c,d=(c=n[l])[0],p=c[1];a.insert(d),s[d]=p}return a.finish(),t.fields=e.fields,t.fieldVectors=i,t.invertedIndex=s,t.tokenSet=a.root,t.pipeline=o,new R.Index(t)},(R.Builder=function(){this._ref="id",this._fields=Object.create(null),this._documents=Object.create(null),this.invertedIndex=Object.create(null),this.fieldTermFrequencies={},this.fieldLengths={},this.tokenizer=R.tokenizer,this.pipeline=new R.Pipeline,this.searchPipeline=new R.Pipeline,this.documentCount=0,this._b=.75,this._k1=1.2,this.termIndex=0,this.metadataWhitelist=[]}).prototype.ref=function(e){this._ref=e},R.Builder.prototype.field=function(e,t){if(/\//.test(e))throw new RangeError("Field '"+e+"' contains illegal character '/'");this._fields[e]=t||{}},R.Builder.prototype.b=function(e){this._b=e<0?0:1<e?1:e},R.Builder.prototype.k1=function(e){this._k1=e},R.Builder.prototype.add=function(e,t){var i=e[this._ref],r=Object.keys(this._fields);this._documents[i]=t||{},this.documentCount+=1;for(var s=0;s<r.length;s++){var n=r[s],a=this._fields[n].extractor,a=a?a(e):e[n],a=this.tokenizer(a,{fields:[n]}),o=this.pipeline.run(a),a=new R.FieldRef(i,n),l=Object.create(null);this.fieldTermFrequencies[a]=l,this.fieldLengths[a]=0,this.fieldLengths[a]+=o.length;for(var u=0;u<o.length;u++){var h=o[u];if(null==l[h]&&(l[h]=0),l[h]+=1,null==this.invertedIndex[h]){var c=Object.create(null);c._index=this.termIndex,this.termIndex+=1;for(var d=0;d<r.length;d++)c[r[d]]=Object.create(null);this.invertedIndex[h]=c}null==this.invertedIndex[h][n][i]&&(this.invertedIndex[h][n][i]=Object.create(null));for(var p=0;p<this.metadataWhitelist.length;p++){var m=this.metadataWhitelist[p],v=h.metadata[m];null==this.invertedIndex[h][n][i][m]&&(this.invertedIndex[h][n][i][m]=[]),this.invertedIndex[h][n][i][m].push(v)}}}},R.Builder.prototype.calculateAverageFieldLengths=function(){for(var e=Object.keys(this.fieldLengths),t=e.length,i={},r={},s=0;s<t;s++){var n=R.FieldRef.fromString(e[s]),a=n.fieldName;r[a]||(r[a]=0),r[a]+=1,i[a]||(i[a]=0),i[a]+=this.fieldLengths[n]}for(var o=Object.keys(this._fields),s=0;s<o.length;s++){var l=o[s];i[l]=i[l]/r[l]}this.averageFieldLength=i},R.Builder.prototype.createFieldVectors=function(){for(var e={},t=Object.keys(this.fieldTermFrequencies),i=t.length,r=Object.create(null),s=0;s<i;s++){for(var n=R.FieldRef.fromString(t[s]),a=n.fieldName,o=this.fieldLengths[n],l=new R.Vector,u=this.fieldTermFrequencies[n],h=Object.keys(u),c=h.length,d=this._fields[a].boost||1,p=this._documents[n.docRef].boost||1,m=0;m<c;m++){var v,f=h[m],g=u[f],y=this.invertedIndex[f]._index;void 0===r[f]?(v=R.idf(this.invertedIndex[f],this.documentCount),r[f]=v):v=r[f],f=(f=v*((this._k1+1)*g)/(this._k1*(1-this._b+this._b*(o/this.averageFieldLength[a]))+g))*d*p,g=Math.round(1e3*f)/1e3,l.insert(y,g)}e[n]=l}this.fieldVectors=e},R.Builder.prototype.createTokenSet=function(){this.tokenSet=R.TokenSet.fromArray(Object.keys(this.invertedIndex).sort())},R.Builder.prototype.build=function(){return this.calculateAverageFieldLengths(),this.createFieldVectors(),this.createTokenSet(),new R.Index({invertedIndex:this.invertedIndex,fieldVectors:this.fieldVectors,tokenSet:this.tokenSet,fields:Object.keys(this._fields),pipeline:this.searchPipeline})},R.Builder.prototype.use=function(e){var t=Array.prototype.slice.call(arguments,1);t.unshift(this),e.apply(this,t)},(R.MatchData=function(e,t,i){for(var r=Object.create(null),s=Object.keys(i||{}),n=0;n<s.length;n++){var a=s[n];r[a]=i[a].slice()}this.metadata=Object.create(null),void 0!==e&&(this.metadata[e]=Object.create(null),this.metadata[e][t]=r)}).prototype.combine=function(e){for(var t=Object.keys(e.metadata),i=0;i<t.length;i++){var r=t[i],s=Object.keys(e.metadata[r]);null==this.metadata[r]&&(this.metadata[r]=Object.create(null));for(var n=0;n<s.length;n++){var a=s[n],o=Object.keys(e.metadata[r][a]);null==this.metadata[r][a]&&(this.metadata[r][a]=Object.create(null));for(var l=0;l<o.length;l++){var u=o[l];null==this.metadata[r][a][u]?this.metadata[r][a][u]=e.metadata[r][a][u]:this.metadata[r][a][u]=this.metadata[r][a][u].concat(e.metadata[r][a][u])}}}},R.MatchData.prototype.add=function(e,t,i){if(e in this.metadata)if(t in this.metadata[e])for(var r=Object.keys(i),s=0;s<r.length;s++){var n=r[s];n in this.metadata[e][t]?this.metadata[e][t][n]=this.metadata[e][t][n].concat(i[n]):this.metadata[e][t][n]=i[n]}else this.metadata[e][t]=i;else this.metadata[e]=Object.create(null),this.metadata[e][t]=i},(R.Query=function(e){this.clauses=[],this.allFields=e}).wildcard=new String("*"),R.Query.wildcard.NONE=0,R.Query.wildcard.LEADING=1,R.Query.wildcard.TRAILING=2,R.Query.presence={OPTIONAL:1,REQUIRED:2,PROHIBITED:3},R.Query.prototype.clause=function(e){return"fields"in e||(e.fields=this.allFields),"boost"in e||(e.boost=1),"usePipeline"in e||(e.usePipeline=!0),"wildcard"in e||(e.wildcard=R.Query.wildcard.NONE),e.wildcard&R.Query.wildcard.LEADING&&e.term.charAt(0)!=R.Query.wildcard&&(e.term="*"+e.term),e.wildcard&R.Query.wildcard.TRAILING&&e.term.slice(-1)!=R.Query.wildcard&&(e.term=e.term+"*"),"presence"in e||(e.presence=R.Query.presence.OPTIONAL),this.clauses.push(e),this},R.Query.prototype.isNegated=function(){for(var e=0;e<this.clauses.length;e++)if(this.clauses[e].presence!=R.Query.presence.PROHIBITED)return!1;return!0},R.Query.prototype.term=function(e,t){var i;return Array.isArray(e)?e.forEach(function(e){this.term(e,R.utils.clone(t))},this):((i=t||{}).term=e.toString(),this.clause(i)),this},(R.QueryParseError=function(e,t,i){this.name="QueryParseError",this.message=e,this.start=t,this.end=i}).prototype=new Error,(R.QueryLexer=function(e){this.lexemes=[],this.str=e,this.length=e.length,this.pos=0,this.start=0,this.escapeCharPositions=[]}).prototype.run=function(){for(var e=R.QueryLexer.lexText;e;)e=e(this)},R.QueryLexer.prototype.sliceString=function(){for(var e,t=[],i=this.start,r=(this.pos,0);r<this.escapeCharPositions.length;r++)e=this.escapeCharPositions[r],t.push(this.str.slice(i,e)),i=e+1;return t.push(this.str.slice(i,this.pos)),this.escapeCharPositions.length=0,t.join("")},R.QueryLexer.prototype.emit=function(e){this.lexemes.push({type:e,str:this.sliceString(),start:this.start,end:this.pos}),this.start=this.pos},R.QueryLexer.prototype.escapeCharacter=function(){this.escapeCharPositions.push(this.pos-1),this.pos+=1},R.QueryLexer.prototype.next=function(){var e;return this.pos>=this.length?R.QueryLexer.EOS:(e=this.str.charAt(this.pos),this.pos+=1,e)},R.QueryLexer.prototype.width=function(){return this.pos-this.start},R.QueryLexer.prototype.ignore=function(){this.start==this.pos&&(this.pos+=1),this.start=this.pos},R.QueryLexer.prototype.backup=function(){--this.pos},R.QueryLexer.prototype.acceptDigitRun=function(){for(var e,t;47<(t=(e=this.next()).charCodeAt(0))&&t<58;);e!=R.QueryLexer.EOS&&this.backup()},R.QueryLexer.prototype.more=function(){return this.pos<this.length},R.QueryLexer.EOS="EOS",R.QueryLexer.FIELD="FIELD",R.QueryLexer.TERM="TERM",R.QueryLexer.EDIT_DISTANCE="EDIT_DISTANCE",R.QueryLexer.BOOST="BOOST",R.QueryLexer.PRESENCE="PRESENCE",R.QueryLexer.lexField=function(e){return e.backup(),e.emit(R.QueryLexer.FIELD),e.ignore(),R.QueryLexer.lexText},R.QueryLexer.lexTerm=function(e){if(1<e.width()&&(e.backup(),e.emit(R.QueryLexer.TERM)),e.ignore(),e.more())return R.QueryLexer.lexText},R.QueryLexer.lexEditDistance=function(e){return e.ignore(),e.acceptDigitRun(),e.emit(R.QueryLexer.EDIT_DISTANCE),R.QueryLexer.lexText},R.QueryLexer.lexBoost=function(e){return e.ignore(),e.acceptDigitRun(),e.emit(R.QueryLexer.BOOST),R.QueryLexer.lexText},R.QueryLexer.lexEOS=function(e){0<e.width()&&e.emit(R.QueryLexer.TERM)},R.QueryLexer.termSeparator=R.tokenizer.separator,R.QueryLexer.lexText=function(e){for(;;){var t=e.next();if(t==R.QueryLexer.EOS)return R.QueryLexer.lexEOS;if(92==t.charCodeAt(0))e.escapeCharacter();else{if(":"==t)return R.QueryLexer.lexField;if("~"==t)return e.backup(),0<e.width()&&e.emit(R.QueryLexer.TERM),R.QueryLexer.lexEditDistance;if("^"==t)return e.backup(),0<e.width()&&e.emit(R.QueryLexer.TERM),R.QueryLexer.lexBoost;if("+"==t&&1===e.width())return e.emit(R.QueryLexer.PRESENCE),R.QueryLexer.lexText;if("-"==t&&1===e.width())return e.emit(R.QueryLexer.PRESENCE),R.QueryLexer.lexText;if(t.match(R.QueryLexer.termSeparator))return R.QueryLexer.lexTerm}}},(R.QueryParser=function(e,t){this.lexer=new R.QueryLexer(e),this.query=t,this.currentClause={},this.lexemeIdx=0}).prototype.parse=function(){this.lexer.run(),this.lexemes=this.lexer.lexemes;for(var e=R.QueryParser.parseClause;e;)e=e(this);return this.query},R.QueryParser.prototype.peekLexeme=function(){return this.lexemes[this.lexemeIdx]},R.QueryParser.prototype.consumeLexeme=function(){var e=this.peekLexeme();return this.lexemeIdx+=1,e},R.QueryParser.prototype.nextClause=function(){var e=this.currentClause;this.query.clause(e),this.currentClause={}},R.QueryParser.parseClause=function(e){var t=e.peekLexeme();if(null!=t)switch(t.type){case R.QueryLexer.PRESENCE:return R.QueryParser.parsePresence;case R.QueryLexer.FIELD:return R.QueryParser.parseField;case R.QueryLexer.TERM:return R.QueryParser.parseTerm;default:var i="expected either a field or a term, found "+t.type;throw 1<=t.str.length&&(i+=" with value '"+t.str+"'"),new R.QueryParseError(i,t.start,t.end)}},R.QueryParser.parsePresence=function(e){var t=e.consumeLexeme();if(null!=t){switch(t.str){case"-":e.currentClause.presence=R.Query.presence.PROHIBITED;break;case"+":e.currentClause.presence=R.Query.presence.REQUIRED;break;default:var i="unrecognised presence operator'"+t.str+"'";throw new R.QueryParseError(i,t.start,t.end)}var r=e.peekLexeme();if(null==r)throw new R.QueryParseError(i="expecting term or field, found nothing",t.start,t.end);switch(r.type){case R.QueryLexer.FIELD:return R.QueryParser.parseField;case R.QueryLexer.TERM:return R.QueryParser.parseTerm;default:i="expecting term or field, found '"+r.type+"'";throw new R.QueryParseError(i,r.start,r.end)}}},R.QueryParser.parseField=function(e){var t=e.consumeLexeme();if(null!=t){if(-1==e.query.allFields.indexOf(t.str))throw i=e.query.allFields.map(function(e){return"'"+e+"'"}).join(", "),i="unrecognised field '"+t.str+"', possible fields: "+i,new R.QueryParseError(i,t.start,t.end);e.currentClause.fields=[t.str];e=e.peekLexeme();if(null==e)throw new R.QueryParseError(i="expecting term, found nothing",t.start,t.end);if(e.type===R.QueryLexer.TERM)return R.QueryParser.parseTerm;var i="expecting term, found '"+e.type+"'";throw new R.QueryParseError(i,e.start,e.end)}},R.QueryParser.parseTerm=function(e){var t=e.consumeLexeme();if(null!=t){e.currentClause.term=t.str.toLowerCase(),-1!=t.str.indexOf("*")&&(e.currentClause.usePipeline=!1);var i=e.peekLexeme();if(null==i)e.nextClause();else switch(i.type){case R.QueryLexer.TERM:return e.nextClause(),R.QueryParser.parseTerm;case R.QueryLexer.FIELD:return e.nextClause(),R.QueryParser.parseField;case R.QueryLexer.EDIT_DISTANCE:return R.QueryParser.parseEditDistance;case R.QueryLexer.BOOST:return R.QueryParser.parseBoost;case R.QueryLexer.PRESENCE:return e.nextClause(),R.QueryParser.parsePresence;default:var r="Unexpected lexeme type '"+i.type+"'";throw new R.QueryParseError(r,i.start,i.end)}}},R.QueryParser.parseEditDistance=function(e){var t=e.consumeLexeme();if(null!=t){var i=parseInt(t.str,10);if(isNaN(i))throw new R.QueryParseError(s="edit distance must be numeric",t.start,t.end);e.currentClause.editDistance=i;var r=e.peekLexeme();if(null==r)e.nextClause();else switch(r.type){case R.QueryLexer.TERM:return e.nextClause(),R.QueryParser.parseTerm;case R.QueryLexer.FIELD:return e.nextClause(),R.QueryParser.parseField;case R.QueryLexer.EDIT_DISTANCE:return R.QueryParser.parseEditDistance;case R.QueryLexer.BOOST:return R.QueryParser.parseBoost;case R.QueryLexer.PRESENCE:return e.nextClause(),R.QueryParser.parsePresence;default:var s="Unexpected lexeme type '"+r.type+"'";throw new R.QueryParseError(s,r.start,r.end)}}},R.QueryParser.parseBoost=function(e){var t=e.consumeLexeme();if(null!=t){var i=parseInt(t.str,10);if(isNaN(i))throw new R.QueryParseError(s="boost must be numeric",t.start,t.end);e.currentClause.boost=i;var r=e.peekLexeme();if(null==r)e.nextClause();else switch(r.type){case R.QueryLexer.TERM:return e.nextClause(),R.QueryParser.parseTerm;case R.QueryLexer.FIELD:return e.nextClause(),R.QueryParser.parseField;case R.QueryLexer.EDIT_DISTANCE:return R.QueryParser.parseEditDistance;case R.QueryLexer.BOOST:return R.QueryParser.parseBoost;case R.QueryLexer.PRESENCE:return e.nextClause(),R.QueryParser.parsePresence;default:var s="Unexpected lexeme type '"+r.type+"'";throw new R.QueryParseError(s,r.start,r.end)}}},e=this,i=function(){return R},"function"==typeof define&&define.amd?define(i):"object"==typeof exports?module.exports=R:e.lunr=R}(),Mavo.Functions.telify=$.extend(e=>(e+"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^\w\s-]/g,"").trim().replace(/\s+/g,"").replace("0","+33").toLowerCase(),{multiValued:!0}),!1);function loadContacts(){if(!contactLoaded){let t=document.getElementById("contacts");t&&fetch("/contents/annuaire.json").then(e=>e.json()).then(e=>{let r={};e.contact.forEach(e=>{t.innerHTML+="<option>"+e.id+"</option>",r[e.id]=e}),Array.from(document.querySelectorAll('span[mv-editor-list="contacts"]:not(:empty)')).forEach(e=>{var t,i=r[e.innerText];i&&i.id&&(e.setAttribute("for",i.id),(t=document.createElement("div")).setAttribute("id",i.id),t.setAttribute("class","contact"),t.innerHTML+='<h5 class="nom">'+i.nom+"</h5>",i.email&&(t.innerHTML+='<a href="mailto:'+i.email+'"><span class="fa-solid fa-envelope">'+i.email+"</span></a>"),i.telephone&&(t.innerHTML+='<a href="tel:'+Mavo.Functions.telify(i.telephone)+'"><span class="fa-solid fa-phone">'+i.telephone+"</span></a>"),e.parentNode.append(t))}),contactLoaded=!0}).catch(e=>{console.error("Error:",e)})}}function addContactsSearch(){let i=document.getElementById("fonction");if(i){let t=[],e=(Array.from(document.querySelectorAll('div[property="contact"] div[property="fonction"]:not(:empty)')).forEach(e=>{e=e.innerText.split(/[, ]/)[0];t.includes(e)||t.push(e)}),t.sort().forEach(e=>{i.innerHTML+='<option value="'+e+'">'+e+"</option>"}),i.addEventListener("change",()=>{e.value="";let i=document.getElementById("fonction").value;Array.from(document.querySelectorAll("div.contact")).forEach(e=>{var t=e.getAttribute("data-fonction").split(/[, ]/)[0];i&&t!=i?e.setAttribute("hidden","hidden"):e.removeAttribute("hidden")})}),document.getElementById("fulltext"));e.addEventListener("input",()=>{i.value="";let t=e.value.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"");Array.from(document.querySelectorAll("div.contact")).forEach(e=>{-1<e.getAttribute("data-fulltext").indexOf(t)?e.removeAttribute("hidden"):e.setAttribute("hidden","hidden")})})}}function fullSearch(t){t&&(Array.from(document.querySelectorAll("input[type=text][name=texte]")).forEach(e=>{e.value=decodeURIComponent(t)}),fetch("/.netlify/functions/recherche/?texte="+t,{mode:"no-cors"}).then(e=>e.json()).then(e=>{var r=document.createElement("ol"),t=document.getElementById("results");e.length?(e.forEach(e=>{var t=document.createElement("li"),i=(i=JSON.parse(e.c).description||"").replaceAll("<img [^>]+>","");t.innerHTML='<article class="result"><h3><a href="'+e.i+'">'+e.t+"</a></h3><span>"+i+"</span></article>",r.append(t)}),(t=document.getElementById("results")).innerHTML='<h2 property="resultats">Résultats:</h2>',t.append(r)):t.innerHTML='<h2 property="pasderesultats" class="center">Pas de résultat</h2>'}))}function renderPsaumes(e,t){console.log(e);var i=(i=(i=(i=(i='<table cellpadding="0" cellspacing="0">')+("<caption>"+t+"</caption>")+"<thead><tr>")+"<th>Année</th>"+"<th>Nom</th>")+"<th>Titre</th>"+"<th>Partition</th>")+"<th>Musique</th></thead>"+"<tbody>";return e.forEach(e=>{i=(i=(i=(i=(i+="<tr>")+`<td>${e.annee}</td>`)+`<td>${e.nom}</td>`)+`<td>${e.titre}</td>`)+`<td><a href="${e.pdf}" target="_blank">PDF</a></td>`+"<td>",e.mp3.forEach(e=>{i+=`<a href="${e.file}" target="_blank">${e.nom}</a><br/>`}),i+="</td></tr>"}),i=i+"</tbody>"+"</table>"}function initPsaumes(){document.querySelector('#psaumes input[name="date"]').addEventListener("change",e=>{var i=new Date(e.target.value);fetch(`/.netlify/functions/temps-liturgique/?date=${i.getDate()<=9?0:""}${i.getDate()}/${i.getMonth()<9?0:""}${i.getMonth()+1}/`+i.getFullYear(),{mode:"no-cors"}).then(e=>e.json()).then(e=>{var t=e.tempsLiturgique;fetch(`/.netlify/functions/psaume/?annee=${t.anneeLiturgique}&temps=${t.tempsLiturgique}&semaine=`+t.numeroSemaine,{mode:"no-cors"}).then(e=>e.json()).then(e=>{e=renderPsaumes([e[0]],i.toLocaleDateString("fr-FR",{weekday:"long",year:"numeric",month:"long",day:"numeric"})+" : "+t.asString);document.getElementById("psaumesResults").innerHTML=e})})}),document.querySelector('#psaumes input[name="texte"]').addEventListener("input",e=>{var t=e.target.value;fetch("/.netlify/functions/psaume/?texte="+t,{mode:"no-cors"}).then(e=>e.json()).then(e=>{e=renderPsaumes(e,`<em>${e.length}</em> résultats pour <em>${t}</em>`);document.getElementById("psaumesResults").innerHTML=e})})}function getLabelForTag(t){try{return document.querySelector('#autres select option[value="'+t.trim()+'"]').innerText}catch(e){return console.error("Cannot find "+t),""}}function renderAutresChants(e,t){console.log(e);var i=(i=(i=(i='<table cellpadding="0" cellspacing="0">')+("<caption>"+t+"</caption>")+"<thead><tr>")+"<th>Titre</th>"+"<th>Partition</th>")+"<th>Catégories</th></thead>"+"<tbody>";return e.forEach(e=>{i=(i=(i+="<tr>")+`<td>${e.titre}</td>`)+`<td><a href="${e.pdf}" target="_blank">PDF</a></td>`+"<td>",labels="",e.tag.forEach(e=>{labels+=getLabelForTag(e)+" - "}),i=i+labels.replaceAll("^(.*) - $","$1")+"</td></tr>"}),i=i+"</tbody>"+"</table>"}function initAutresChants(){document.querySelector('#autres input[name="texte"]').addEventListener("input",t=>{fetch("/.netlify/functions/chants/?texte="+t.target.value,{mode:"no-cors"}).then(e=>e.json()).then(e=>{e=renderAutresChants(e,`<em>${e.length}</em> résultats pour <em>${t.target.value}</em>`);document.getElementById("chantsResults").innerHTML=e})}),Array.from(document.querySelectorAll("#autres select")).forEach(e=>{e.addEventListener("change",e=>{var t=document.querySelector('#autres select[name="temps"]').value,i=document.querySelector('#autres select[name="etape"]').value,r="_"==t?[i]:"_"==i?[t]:[t,i],s="_"==t?getLabelForTag(i):"_"==i?getLabelForTag(t):getLabelForTag(t)+" - "+getLabelForTag(i);console.log(t,i),fetch("/.netlify/functions/chants/?tag="+r,{mode:"no-cors"}).then(e=>e.json()).then(e=>{e=renderAutresChants(e,`<em>${e.length}</em> résultats pour <em>${s}</em>`);document.getElementById("chantsResults").innerHTML=e})})})}function searchAutresChants(e,t){var i="";return t&&t.forEach(e=>{i+=`+tag:${e} `}),e&&(i+="+"+e),console.log(i),autresChantsIndex.search(i).map(t=>autresChantsData.find(e=>t.ref==e.id))}function initChants(){initPsaumes(),initAutresChants(),Array.from(document.querySelectorAll("form")).forEach(e=>{e.classList.add("hide")}),Array.from(document.querySelectorAll("form.active")).forEach(e=>{e.classList.remove("hide")}),Array.from(document.querySelectorAll(".tabs>li")).forEach(e=>{e.addEventListener("click",function(){Array.from(e.parentElement.parentElement.querySelectorAll("form")).forEach(e=>{e.classList.add("hide")}),Array.from(e.parentElement.querySelectorAll("li")).forEach(e=>{e.classList.remove("active")}),(f=document.getElementById(e.attributes["data-tab"].value)).classList.remove("hide"),e.classList.add("active")})})}function idifyLecture(e,t,i,r){return r+`,${i}(${e})`+t}function renderLectures(e,t){console.log(e);var i=(i=(i=(i='<table cellpadding="0" cellspacing="0">')+("<caption>"+t+"</caption>")+"<thead><tr>")+"<th>Lecture de la messe</th>"+"<th>Titre</th>")+"<th>Identifiant</th>"+"<tbody>";return e.forEach(e=>{i=(i=(i=(i+="<tr>")+`<td>${e.type}</td>`)+`<td>${e.titre}</td>`)+`<td>${e.id}</td>`+"</tr>"}),i=i+"</tbody>"+"</table>"}function initBibleIndex(){fetch("/index/bible/livres.json").then(e=>e.json()).then(function(e){bibleData=e,bibleIndex=lunr(function(){this.ref("ref"),this.field("ref",{boost:1}),this.field("id",{boost:10}),this.field("type",{boost:10}),this.field("temps",{boost:5}),this.field("annee",{boost:1}),this.field("date",{boost:2}),this.field("nom",{boost:8}),this.field("titre",{boost:10}),this.field("text",{boost:1}),this.field("pdf",{boost:1}),idx=this,bibleData.forEach(function(e,t,i){e.ref=idifyLecture(e.annee,e.temps,e.semaine,e.jour),idx.add(e)})})}),fetch("/index/lectures.json").then(e=>e.json()).then(function(e){lecturesData=e,lecturesIndex=lunr(function(){this.ref("ref"),this.field("ref",{boost:1}),this.field("id",{boost:10}),this.field("annee",{boost:10}),this.field("temps",{boost:5}),this.field("semaine",{boost:1}),this.field("jour",{boost:2}),this.field("date",{boost:8}),this.field("originalDate",{boost:10}),this.field("lectures",{boost:1}),idx=this,lecturesData.forEach(function(e,t,i){e.ref=idifyLecture(e.annee,e.temps,e.semaine,e.jour),idx.add(e)})})}),document.querySelector('#filters input[name="date"]').addEventListener("change",e=>{var e=new Date(e.target.value),t=determinerTempsLiturgique(e),i=searchLecturesByTempsLiturgique(t)[0],i=(console.log("result",i),renderLectures(i.lectures,e.toLocaleDateString("fr-FR",{weekday:"long",year:"numeric",month:"long",day:"numeric"})+" : "+renderDateLiturgique(t)));document.getElementById("results").innerHTML=i}),document.querySelector('#filters input[name="id"]').addEventListener("input",e=>{var t=searchLecturesById(e.target.value),t=(console.log("result",t),renderLectures(t.lectures,`Lectures pour <em>${e.target.value}</em>`));document.getElementById("results").innerHTML=t}),document.querySelector('#filters select[name="type"]').addEventListener("input",e=>{var t=searchLecturesByText(e.target.value),t=(console.log("result",t),renderLectures(t.lectures,`Lectures pour <em>${e.target.value}</em>`));document.getElementById("results").innerHTML=t})}function searchLecturesByTempsLiturgique(e){return searchLectures("+ref:"+idifyLecture(e.anneeLiturgique,e.tempsLiturgique,e.numeroSemaine,e.jourSemaine))}function searchLecturesById(e){return searchLectures("+id="+e)}function searchLectures(e){return console.log(e),lecturesIndex.search(e).map(t=>lecturesData.find(e=>t.ref==idifyLecture(e.annee,e.temps,e.semaine,e.jour)))}function initBible(){initBibleIndex(),Array.from(document.querySelectorAll("form")).forEach(e=>{e.classList.add("hide")}),Array.from(document.querySelectorAll("form.active")).forEach(e=>{e.classList.remove("hide")}),Array.from(document.querySelectorAll(".tabs>li")).forEach(e=>{e.addEventListener("click",function(){Array.from(e.parentElement.parentElement.querySelectorAll("form")).forEach(e=>{e.classList.add("hide")}),Array.from(e.parentElement.querySelectorAll("li")).forEach(e=>{e.classList.remove("active")}),(f=document.getElementById(e.attributes["data-tab"].value)).classList.remove("hide"),e.classList.add("active")})})}String.prototype.replaceAll=function(e,t){return this.replace(new RegExp(e,"gm"),t)},document.addEventListener("DOMContentLoaded",()=>{document.querySelector("main[mv-app=chants]")&&initChants(),document.querySelector("main[mv-app=bible]")&&initBible(),document.querySelector("main[mv-app=recherche]")&&fullSearch(document.location.href.split("texte=")[1]),Mavo.inited.then(()=>(setTimeout(()=>{loadContacts()},500),Mavo.all[0].dataLoaded)).then(()=>{setTimeout(()=>{loadContacts(),addContactsSearch()},1e3)})});