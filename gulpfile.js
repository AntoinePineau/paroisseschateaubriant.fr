...
gulp.task('js', () => {
  return gulp.src(['src/res/js/lib/mavo.js', 'src/res/js/lib/mavo-tinymce.js', 'src/res/js/lib/mavo-locale-fr.js', 'src/res/js/lib/mavo-cropper.js','src/res/js/lib/lunr.js', 'src/res/js/contact.js', 'src/res/js/search.js', 'src/res/js/chants.js', 'src/res/js/bible.js', 'src/res/js/main.js'])
